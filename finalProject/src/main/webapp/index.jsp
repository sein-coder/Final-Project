        ...
        <div class="row">
          <div class="col-md-6 mb-4 mb-lg-0 col-lg-4">
            <div class="how-it-work-step">
              <div class="img-wrap">
                <img src="${pageContext.request.contextPath }/resources/images/wm.png" alt="Free website template by Free-Template.co" class="img-fluid">
              </div>
          ...
          <div class="col-md-6 mb-4 mb-lg-0 col-lg-4">
            <div class="how-it-work-step">
              <div class="img-wrap">
                <img src="${pageContext.request.contextPath }/resources/images/man.png" alt="Free website template by Free-Template.co" class="img-fluid">
              </div>
