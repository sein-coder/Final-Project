               ...
               <div class="col-12 col-md-9 d-none d-xl-block">
                  <nav class="site-navigation position-relative text-right"
                     ...
                     <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                        ...
                        <li><a href="${pageContext.request.contextPath }/map" style="font-family: BinggraeMelona !important;"><span>푸드트럭존 찾기</span></a></li>
                        <li><a
                        ...
                        <c:if test="${empty loginMember }">
                           <li>
                              <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#myModal" style="font-family: BinggraeMelona !important;">로그인</button>
                           </li>
                           <li><button class="btn btn-outline-primary" type="button" onclick="location.href='${pageContext.request.contextPath}/member/memberEnrollEnd'">회원가입</button></li>
                        </c:if>
                     ...
                     <div class="row">
                        <div class="col">
                           ...
                           <ul class="nav nav-tabs">
                              <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#member_log">사용자</a></li>
                              <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#partner_log">사업자</a></li>   
                           </ul>
